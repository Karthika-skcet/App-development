...
import './Login.css'; // Use the new CSS file for horizontal layout
...
const PharmacySignup = () => {
  ...
  const navigate = useNavigate(); // Uncomment this line if you plan to use navigation
  const HandleLogin=()=>{
    navigate('/userlogin');
  }
